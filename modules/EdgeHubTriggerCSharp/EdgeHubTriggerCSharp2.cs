...
{
    public static class EdgeHubTriggerCSharp2
    {
        [FunctionName("EdgeHubTriggerCSharp2")]
        public static async Task FilterMessageAndSendMessage(
                    [EdgeHubTrigger("input2")] Message messageReceived,
                    [EdgeHub(OutputName = "output2")] IAsyncCollector<Message> output,
                    TraceWriter log)
        {
            ...
            {
                log.Info("Info: EdgeHubTriggerCSharp2 Received one non-empty message");
                ...
                filteredMessage.Properties.Add("Function", "EdgeHubTriggerCSharp2");
                await output.AddAsync(filteredMessage).ConfigureAwait(false);
                log.Info("Info: EdgeHubTriggerCSharp2 Piped out the message");
            }
        }
